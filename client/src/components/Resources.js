              ...
              <div className="yt-simpleContainer">
                ...
                <div className="iframe_contentRes">
                  <iframe
                    width="853"
                    height="480"
                    src="https://www.youtube.com/embed/InigFUSiPl8?list=PLu0W_9lII9aiL0kysYlfSOUgY5rNlOhUd"
                    title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen
              ...
              <div className="yt-simpleContainer">
                <div className="iframe_contentRes">
                  <iframe
                    width="560"
                    height="315"
                    src="http://www.youtube.com/embed/videoseries?list=PLbRMhDVUMngcdUbBySzyzcPiFTYWr4rV_"
                    frameborder="0"
                    allowfullscreen
                  ></iframe>{" "}
                </div>
