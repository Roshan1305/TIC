        ...
        <div className="landing-left">
          <div className="contact-badge">
            <a
              ...
              href="https://www.instagram.com/techinclub/"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://twitter.com/techinclub"
            >
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.linkedin.com/in/techinclub"
            >
          ...
          <div className="title-andContent">
            <p className="iot-title">
              <label>Tech</label> Innovation&nbsp;Club
            </p>
          ...
          <div className="scroll-indicator">
            <img
              ...
              width="75px"
              height="75px"
              className="scrolldown-indicator"
            />
          </div>
          <img
            src="circle-1.svg"
      ...
      <div className="home-nextLanding">
        <div className="second-landing">
          <div className="second-startingContent">
            ...
            <p className="second-whoContent">
              Tech Innovation club(TIC), is a privileged club of SASTRA TBI,
              managed by students and coordinate the concerned faculty, helps in
              the development of student growth to enable them to generate new
              ideas and become more innovative by leveraging the latest
              technology.
            </p>
          </div>
              ...
              {nextHolder ? (
                <div>
                  ...
                  <div className="card-desc">
                    <p>
                      {nextHolder[0].event_desc.substr(0, 150)}...{" "}
                      <Link to={`/events/${nextHolder[0]._id}`}>
                        READ&nbsp;MORE
                      </Link>
                    </p>
                  </div>
                ...
                <div className="marquee-mela">
                  <div className="trivia-relative">
                    <Tooltip title="Arduino" aria-label="arduino">
                      <Typography>
                        <img
                          className="trivia-back"
                          src="trivia-circle.svg"
                          width="200px"
                          height="200px"
                        />
                        <img
                          className="marquee-icons"
                          src="arduino-icon.svg"
                          width="150px"
                          height="75px"
                        />
                      </Typography>
        ...
        <div className="nearly-slideshow">
          ...
          <div className="what-weDo">
            <h1>What&nbsp;We&nbsp;DO???</h1>
            <p>
              The objective of this club serves as a place of community for
              students to motivate the young Entrepreneurs. This club is
              intended to Skill Development, Student Innovation, Startup
              support, MVP and Product Building, and conduct training programs
              by faculty and core teams of Tech Innovation club. Through the
              club, where the students to learn more about the Internet of
              Things, Artificial Intelligence, App development, Robotics and
              more.
            </p>
          </div>
        ...
        <div className="contact-modal">
          <div className="contact-question">Does IoT interest you ???</div>
          <hr />
          {yes == false && no == false ? (
            ...
            <div className="contact-answer">
              ...
              <Link to="/resources">Resources Section</Link>
              &nbsp; may help you elevate your interests...
            </div>
          )}
        </div>
          ...
          <div className="right-footer">
            ...
            <div className="footer-signup">
              ...
              <input
                ...
                onChange={(e) => setsubscribeDetails(e.target.value)}
              />
            ...
            <div className="footer-icons">
              ...
              <div>
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://www.youtube.com/channel/UCaLrLjv2IQxB61csVqsO35w"
                >
                  YouTube
                </a>
                <a
            ...
            <div className="design-develop">
              <p>
                Designed and Developed by <label>Hocus Pocus</label>
              </p>
            </div>
            <div className="copyrights">
              <p>
                © 2021 <label>TIC Club of SASTRA</label>
              </p>
            </div>
          </div>
        </div>
