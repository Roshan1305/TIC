      ...
      {upcoming?.map((single) => (
        <div className="events-upcoming">
          <div className="upcoming-time">
            <span id="date">{returnDate(single.event_date)}</span>
            <br />
          ...
          <a target="blank" href={single.form} id="reg-button">
          ...
          <div className="event_single">
            ...
            <Bounce left={index % 2 === 0 ? propLeft : null} right>
              <div className="timeline_item">
                <img
                  src={
                    !singleEvent.event_images[0]
                      ? "../images/events-sample.jpg"
                      : singleEvent.event_images[0]
                  }
                />
